      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base">
            <Zap className="size-5 text-mirac-red" />
      ...
      {costos && (
        <>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                <DollarSign className="size-5 text-mirac-red" />
                Desglose de Costos
              </CardTitle>
              {clienteNombre && (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                <Package className="size-5 text-mirac-yellow" />
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  <Ruler className="size-5 text-mirac-yellow" />
                  <div>
