    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Link href="/cotizacion">
          <Card className="cursor-pointer transition-shadow hover:shadow-md">
            <CardContent className="flex items-center gap-3 p-4">
              <div className="flex size-10 items-center justify-center rounded-lg bg-mirac-red/10 text-mirac-red">
        ...
        <Link href="/propuestas">
          <Card className="cursor-pointer transition-shadow hover:shadow-md">
            <CardContent className="flex items-center gap-3 p-4">
              <div className="flex size-10 items-center justify-center rounded-lg bg-mirac-yellow/10 text-mirac-yellow">
...
function StatusBadge({ status }: { status: QuotationData['status'] }) {
  const s = STATUS_BADGE_MAP[status] ?? STATUS_BADGE_MAP.draft
