      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" onClick={() => {
            ...
            <GitBranch className="mr-1 size-3" /> Crear Versión
          </Button>
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base">
                  <MapPin className="size-4" /> Proyecto
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-1 text-sm">
          ...
          {proposal.project.lat != null && proposal.project.lon != null && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base">
                  <MapPin className="size-4" /> Ubicación del Proyecto
                </CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {r.inversores.map((inv) => (
                  <Badge key={`${inv.marca}-${inv.modelo}-${inv.potencia_kw}`} variant="outline">{inv.cantidad}x {inv.marca} {inv.modelo} ({inv.potencia_kw}kW)</Badge>
                ))}
              </div>
            </CardContent>
          </Card>
